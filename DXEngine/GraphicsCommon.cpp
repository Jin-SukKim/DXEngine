...
namespace DE {
	...
	void GraphicsCommon::initDepthStencilStates(ComPtr<ID3D11Device>& device)
	{
		...
		// PassOP�� Stencil/Depth Test�� �� �� pass�ϸ� � Operation�� ���� ����
	...
	void GraphicsCommon::initShaders(ComPtr<ID3D11Device>& device)
	{
		...
		// Batched Particle
		D3D11Utils::CreateVSAndIL(device, L"BatchedParticleVS.hlsl", particleIEs, batchedParticleVS, particleIL);
		D3D11Utils::CreateVSAndIL(device, L"BatchedParticleMeshVS.hlsl", basicIEs, batchedParticleMeshVS, basicIL);
	}
	...
	void GraphicsCommon::initPipelineStates(ComPtr<ID3D11Device>& device)
	{
		...
		// 1�� Masking�� Mirror �κи� BlendState�� Ȱ���ؼ� �׷��ֱ�
		...
		// �ణ �ٸ� Topology�� ��� (POINTLIST�̹Ƿ� �������� Draw()�� ���)
		...
		// Batched Particle PSOs
		particle.batchedAnimPSO = particle.animPSO;
		particle.batchedAnimPSO.vertexShader = batchedParticleVS;

		particle.batchedMeshPSO = particle.meshPSO;
		particle.batchedMeshPSO.vertexShader = batchedParticleMeshVS;
	}
}