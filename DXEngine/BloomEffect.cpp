...
void DE::BloomEffect::Initialize(const std::vector<ComPtr<ID3D11ShaderResourceView>>& resources, const std::vector<ComPtr<ID3D11RenderTargetView>>& targets, int width, int height)
{
	...
	for (int i = 0; i < m_bloomLevels; ++i) {
		// ���� ũ����� �����ؼ� 2�辿 �ִ� 2^bloomLevels���� Down/Up Sampling�ϱ� ���� div�� ������
		int div = int(pow(2, i));
		this->CreateBuffer(width / div, height / div, m_bloomTextures[i]);
	}

	// Down-Sampling - �ػ󵵸� ���缭(Down Sampling) Blur ȿ�� ������ �� �ξ� �ε巯�� ����� �� �� �ְ� ��
	...
	for (int i = 0; i < m_bloomLevels - 1; ++i) {
		...
		// i ��° Texture�� �����͸� ������ i + 1��° Texture�� Rendering (��, 0�� Index�� �������� �ػ󵵰� ���� Texture�̱⿡ ���� ���� �ػ󵵷� Down-Sampling)
		if (i == 0)
	...
	// Up-Sampling - Gaussian Blur�� 2�辿 Up Sampling�� ���� �ػ󵵱��� ���������� ����
	...
	for (int i = 0; i < m_bloomLevels - 1; ++i) {
		...
		// i + 1��° Texture�� �о i ��° Texture�� Rendering (0�� Index���� �ּ��� �ػ󵵰� ���� Texture�̱⿡ ���� Texture���� ���� Texture�� Up-Sampling)
