...
namespace DE {
	...
	public:
		...
		static void CreateVertexBufferPool(ComPtr<ID3D11Device>& device, const UINT& maxCount, ComPtr<ID3D11Buffer>& vertexBuffer) {
			...
			desc.ByteWidth = UINT(sizeof(T_VERTEX) * maxCount); // �̸� ũ�� ���� (��: 100����)
			desc.BindFlags = D3D11_BIND_VERTEX_BUFFER;
		...
		// Hull Shader ���� (Control Points�� �̷���� Patch�� �ٷ�� Shader)
		...
		// Resource Texture�� ������ �����ͼ� Texture, SRV, RTV ����
		...
		// DDS ���Ϸκ��� Texture ���� (isCubemap�� true�� Cubemap Texture, false�� Texture2D ����)
		...
		// Metal�� Roughness Texture�� �ϳ��� Texture���� ����ϴ� MetallicRoughness Texture ����
