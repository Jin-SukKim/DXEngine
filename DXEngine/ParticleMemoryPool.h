...
struct ParticleMeshConsts {
	...
	UINT vertexCount;
	UINT indexCount;
	UINT systemSlot;      // ★ 추가: Shader에서 인덱싱용
	float padding[1];
};
struct SpawnRef {
...
public:
	...
	StructuredBuffer<ParticleMeshConsts>& GetMeshConsts() { return m_meshConsts; }
